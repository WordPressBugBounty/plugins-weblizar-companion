...
class wl_companion_portfolios_enigma_parallax
{
    public static function wl_companion_portfolios_enigma_parallax_html() {
        ...
        <div class="enigma_project_section <?php echo ($theme_name == 'Oculis') ? 'portfolio2' : ''; ?>">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 pull-left scrollimation fade-right d1">
                                        <div class="img-wrapper">
                                            <div class="enigma_home_portfolio_showcase">
                                                <img class="enigma_img_responsive" src="<?php echo esc_url($item['portfolio_image']); ?>" alt="<?php echo esc_attr($item['portfolio_name']); ?>">
                                            ...
                                            <?php if (!empty($item['portfolio_name'])) : ?>
                                                <div class="enigma_home_portfolio_caption">
                                                    <h3 class="port_<?php echo esc_attr($key); ?>">
            ...
            <?php else : ?>
                <!-- Fallback if no portfolio data is available -->
                <div class="container">
                    <div class="row">
                        <div id="enigma_portfolio_section" class="enima_photo_gallery">
                            <?php for ($i = 1; $i <= 4; $i++) : ?>
                                <?php if (!empty(get_theme_mod('port_' . $i . '_img'))) : ?>
                                    <div class="col-lg-3 col-md-3 col-sm-6 pull-left scrollimation fade-right d1">
                                        <div class="img-wrapper">
                                            <div class="enigma_home_portfolio_showcase">
                                                <img class="enigma_img_responsive" src="<?php echo esc_url(get_theme_mod('port_' . $i . '_img')); ?>" alt="<?php echo esc_attr(get_theme_mod('port_' . $i . '_title', 'Bonorum')); ?>">
                                                <div class="enigma_home_portfolio_showcase_overlay">
                                                    <div class="enigma_home_portfolio_showcase_overlay_inner">
                                                        <div class="enigma_home_portfolio_showcase_icons">
                                                            <a title="<?php echo esc_attr(get_theme_mod('port_' . $i . '_title', 'Bonorum')); ?>" href="<?php echo esc_url(get_theme_mod('port_' . $i . '_link', '#')); ?>">
                                                                <i class="fa fa-link"></i>
                                                            </a>
                                                            <a class="photobox_a" href="<?php echo esc_url(get_theme_mod('port_' . $i . '_img')); ?>">
                                                                <i class="fa fa-search-plus"></i>
                                                                <img src="<?php echo esc_url(get_theme_mod('port_' . $i . '_img')); ?>" alt="<?php echo esc_attr(get_theme_mod('port_' . $i . '_title', 'Bonorum')); ?>" style="display:none !important;visibility:hidden">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php if (!empty(get_theme_mod('port_' . $i . '_title'))) : ?>
                                                <div class="enigma_home_portfolio_caption">
